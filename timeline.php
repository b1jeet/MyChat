...
if (mysqli_num_rows($r) > 0) {
    ...
    while($row = mysqli_fetch_assoc($r)) {
         ...
         function displaytweets()
      {
        ...
        global $h;
        $whereClause="";
        $query = "SELECT DISTINCT follower FROM isfollowing WHERE isfollowing= ". mysqli_real_escape_string($con,$h);
           ...
           while ($row_1 = mysqli_fetch_assoc($result)) {
                ...
                $whereClause.= " userid = ".$row_1['follower'];
         
        $a_query="SELECT * FROM tweets ".$whereClause;
